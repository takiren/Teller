...
void BasicApp::draw()
{
	...
	auto col = gl::ScopedColor(0.5f, 0.5f, 0.5f);
	gl::drawSolidRect(ci::app::getWindowBounds());
	gl::color(Color(1, 0, 0));
	gl::drawSolidRect(Rectf(0,0,1920,1080));
	gl::color(Color(1, 1, 1));

	gl::drawString("Hello ssssssworld", vec2(500, 300), ci::Color(1, 1, 1));
	mFbo->unbindFramebuffer();
	gl::draw(mFbo->getColorTexture(), Rectf(0,0,1280,720));

	gl::color(Color(1, 1, 1));

	gl::drawSolidRect(Rectf(0,0,200,100));
